...
public class ShopBrowseManagerExecutor extends AbstractShopTransactionCmdExecutor {
    ...
    public ShopBrowseManagerExecutor(PlayerShopsRPG plugin) {
        super(plugin);
    }
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        return super.executeTransaction(src, args, (player, arg, shop) -> shop.showManagerView(player), Messages.BROWSE_CONSOLE_REJECT);
    }
}
