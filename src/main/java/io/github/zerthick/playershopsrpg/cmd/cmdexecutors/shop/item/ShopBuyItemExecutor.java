...
public class ShopBuyItemExecutor extends AbstractShopTransactionCmdExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        return super.executeTransaction(src, args, (player, arg, shop) -> {
            ...
            if (itemIndexArgumentOptional.isPresent() && itemAmountArgumentOptional.isPresent()) {
                ...
                return shop.sellItem(player, itemIndexArgumentOptional.get(), itemAmountArgumentOptional.get());
            }
            return ShopTransactionResult.EMPTY;
        }, "You cannot buy items from shops from the console!");
    }
}
