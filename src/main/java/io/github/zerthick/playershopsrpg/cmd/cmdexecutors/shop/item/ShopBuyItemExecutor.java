...
public class ShopBuyItemExecutor extends AbstractCmdExecutor {

    public ShopBuyItemExecutor(PluginContainer pluginContainer) {
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        if (src instanceof Player) {
            ...
            if (itemIndexArgumentOptional.isPresent() && itemAmountArgumentOptional.isPresent()) {
                ...
                if (shopContainerOptional.isPresent()) {
                    ...
                    ShopTransactionResult transactionResult = shop.sellItem(player, itemIndexArgumentOptional.get(), itemAmountArgumentOptional.get());
        ...
        src.sendMessage(Text.of("You cannot buy items from shops from the console!"));
        return CommandResult.success();
    }
}
