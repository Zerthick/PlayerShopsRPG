...
public class ShopSellItemExecutor extends AbstractCmdExecutor {

    public ShopSellItemExecutor(PluginContainer pluginContainer) {
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        if (src instanceof Player) {
            ...
            if (itemIndexArgumentOptional.isPresent() && itemAmountArgumentOptional.isPresent()) {
                ...
                if (shopContainerOptional.isPresent()) {
                    ...
                    ShopTransactionResult transactionResult = shop.buyItem(player, itemIndexArgumentOptional.get(), itemAmountArgumentOptional.get());
        ...
        src.sendMessage(Text.of("You cannot sell items to shops from the console!"));
        return CommandResult.success();
    }
}
